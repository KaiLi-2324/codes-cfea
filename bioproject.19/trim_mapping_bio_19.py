...
def trim_map_file(fastq, path_fastq, clean_dir, log_dir, mapping_dir, bismark_index, bowtie1_path, mapping_result_dir):
    ...
    cmd_trim = f"perl trim_fastq.pl --indir {path_fastq} --outdir {clean_dir} --sample {prefix}"
    ...
    cmd_filter_2 = f"perl remove_forward6bp.pl {clean_fq_2} {filter_fq_2} 6 20 12"
    cmd_filter_1 = f"perl remove_forward6bp.pl {clean_fq_1} {filter_fq_1} 12 20 6"
    ...
    cmd_ch3 = f"perl remove_reads_3cpg.pl {filter_fq_2} {nonCG_fq_2}"
